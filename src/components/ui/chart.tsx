...
/**
 * Recharts TS types vary by version and may not expose `payload`.
 * We explicitly type only what we use to keep `next build` happy.
 */
...
/**
 * Same issue as Tooltip: we define minimal props so TS doesn't break on build.
 */
